...
this.insert(parent, null, true);
	...
	moveToCell: function() {
		...
		this.container.style.left = cell.offsetLeft + 'px';
		this.container.style.top = 'inherit';
		this.container.style.zIndex = '3';
		cell.parentNode.append(this.container);
	},
...
this.createEditControlsComplete();
	...
	_showInput: function() {
		var cell = GwtListEditWindow.getCellEditWindow();
		var calHeight = $j('#GwtDateTimePicker').height();
		var topPosition = cell.getBoundingClientRect().top + cell.getBoundingClientRect().height;
		if(topPosition + calHeight > getBrowserWindowHeight())
			topPosition = topPosition - calHeight - cell.getBoundingClientRect().height;
		var leftPosition = cell.getBoundingClientRect().left;
		var calWidth = $j('#GwtDateTimePicker').children()[0].getBoundingClientRect().width;
		if(leftPosition + calWidth > getBrowserWindowWidth())
			leftPosition = getBrowserWindowWidth() - calWidth;
	...
	_hideInput: function() {
		...
		var bottomClearance = getBrowserWindowHeight() - top - $(cell).getHeight();
